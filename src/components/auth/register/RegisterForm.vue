    ...
    <div v-if="currentStage === 0" class="space-y-6">
      ...
      <div class="flex justify-center pt-4">
        <button
          ...
          class="rounded-md bg-violet-500 px-8 py-3 text-sm font-semibold text-white hover:bg-violet-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-violet-500 transition-colors disabled:cursor-not-allowed disabled:opacity-50"
        >
          Continue
        </button>
      </div>
          ...
          <template v-for="(stage, index) in currentStages" :key="stage.id">
            <div class="flex flex-col items-center">
              ...
              <span
                :class="[
                  ...
                  currentStage >= index + 1 ? 'text-violet-600' : 'text-gray-500'
                ]"
              >
                {{ stage.name }}
              </span>
            ...
            <div
              ...
              :class="[
                ...
                currentStage > index + 1 ? 'bg-violet-500' : 'bg-gray-200'
              ]"
            />
          </template>
        </div>
      ...
      <form class="space-y-5" @submit.prevent="handleSubmit">
        ...
        <div class="flex justify-between pt-4">
          ...
          <button
            ...
            type="button"
            @click="nextStage"
            class="rounded-md bg-violet-500 px-4 py-2 text-sm font-semibold text-white hover:bg-violet-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-violet-500 transition-colors"
          >
            Next
          </button>
          ...
          <button
            ...
            class="rounded-md bg-violet-500 px-4 py-2 text-sm font-semibold text-white hover:bg-violet-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-violet-500 transition-colors disabled:cursor-not-allowed disabled:opacity-50"
          >
